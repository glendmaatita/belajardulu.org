...
export const GLOSSARY: Record<string, string> = {
  ...
  // ===== Ekspor (eksportir non-produsen / orang biasa) =====
  "eksportir non-produsen": "Eksportir yang tidak memproduksi sendiri, melainkan membeli barang dari produsen lokal lalu menjualnya ke luar negeri.",
  "trading company": "Perusahaan dagang yang membeli barang dari produsen dan menjualnya kembali, termasuk ke pasar ekspor, tanpa memproduksi sendiri.",
  "sourcing": "Proses mencari dan menyeleksi produsen atau pemasok yang tepat untuk memasok barang.",
  "MOQ": "Minimum Order Quantity, jumlah pesanan terkecil yang mau dilayani produsen atau diminta buyer.",
  "undername": "Ekspor memakai bendera (NIB dan PEB) perusahaan lain yang sudah biasa ekspor, dengan membayar fee jasa.",
  "agregator ekspor": "Pihak yang menggabungkan barang dari banyak produsen kecil menjadi satu pengapalan agar bisa diekspor bersama.",
  "konsinyasi": "Menitipkan barang untuk dijual, pembayaran ke pemilik barang dilakukan setelah barang laku.",
  "cross-border e-commerce": "Perdagangan lewat marketplace lintas negara sehingga penjual bisa menjual langsung ke konsumen di luar negeri.",
  "NIB": "Nomor Induk Berusaha, identitas pelaku usaha yang diterbitkan lewat sistem OSS dan menjadi syarat dasar untuk ekspor.",
  "OSS": "Online Single Submission, sistem perizinan berusaha berbasis daring tempat pelaku usaha mengurus NIB.",
  "SKA": "Surat Keterangan Asal (Certificate of Origin), dokumen yang menyatakan negara asal barang agar bisa menikmati tarif preferensi di negara tujuan.",
  "e-SKA": "Sistem daring Kementerian Perdagangan untuk menerbitkan Surat Keterangan Asal barang ekspor.",
  "quotation": "Penawaran harga resmi kepada calon pembeli, biasanya menyebut harga, jumlah, Incoterm, dan masa berlaku.",
  "EXW": "Ex Works, pembeli mengambil barang di lokasi penjual dan menanggung hampir semua biaya serta risiko.",
  "HPE": "Harga Patokan Ekspor, harga acuan yang ditetapkan pemerintah untuk menghitung bea keluar komoditas tertentu.",
  "devisa hasil ekspor": "Valuta asing yang diterima eksportir dari hasil penjualan ekspornya.",
  "DHE SDA": "Devisa Hasil Ekspor Sumber Daya Alam yang wajib disimpan di sistem keuangan dalam negeri sesuai ketentuan pemerintah.",
  "LPEI": "Lembaga Pembiayaan Ekspor Indonesia (Indonesia Eximbank), lembaga negara yang membiayai dan menjamin kegiatan ekspor.",
  "phytosanitary": "Sertifikat karantina tumbuhan yang menyatakan produk bebas hama, sering diminta untuk ekspor produk pertanian.",
  "open account": "Skema pembayaran ketika barang dikirim lebih dulu dan dibayar kemudian sesuai tenggat yang disepakati.",
